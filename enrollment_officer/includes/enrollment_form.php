<?php
	...
	if(isset($_POST['insert'])){
		...
		$sql2 = "INSERT INTO enrollment(`student_id`, `status`) 
...
?>
	...
	<div class="container mb-4 border border-light rounded">
		
		<form method="post" action="manage_student.php" class="mt-3">
			...
			<div class="row">
				<div class="col-4">
					<div class="form-group">
						...
						<input type="text" class="form-control" name="lrn" id="lrn" aria-describedby="emailHelp" placeholder="LRN Number" required>
					</div>
				</div>
				<div class="col-4">
					<?php 
						$query= mysqlI_query($con, "SELECT * FROM grade_level");
					?>
					<label class="mr-sm-2" for="sy">Grade Level</label>
					<select class="custom-select" name="grade_level" id="sy">
						<?php
							while($row = mysqli_fetch_array($query)){
						?>
						<option value="<?php $row['grade_level_id']; ?>">Grade - <?php echo $row['grade_level'];?></option>
							<?php } ?>
					</select>
				</div>
				<div class="col-4">
			...
			<div class="row mt-3">
				<div class="col-12">
					...
					<input type="text" name="school_id_number" placeholder="School ID Number" class="form-control w-100 rounded">
				</div>
				<div class="col">
			...
			<h5 class="mt-5 text-primary">Requirements</h5>
			<hr>
			<div class="mb-3">
				<div class="row">
					<div class="col-4">
