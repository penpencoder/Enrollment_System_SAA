            ...
            <div class="row">
                <div class="col-2 bg-secondary mt-5" style="height: 650px; position: fixed;">
                    <ul class="nav flex-column" style="width: 180px;">
                        <!--li class="nav-item">
                            <h6><a class="nav-link active text-white" href="faculty_home.php"><i class="fas fa-home"></i> Home</a></h6> 
                        </li-->
                        <li class="nav-item">
                            <h6><a class="nav-link text-white" href="faculty_schedule.php"><i class="far fa-calendar"></i> Schedule</a><h6>
                        </li>
                        <li class="nav-item">
                            <h6><a class="nav-link text-white" href="clearance.php"><i class="fas fa-check-circle"></i> Clearance</a><h6>
                        </li>
                        <li class="nav-item">
                            <h6><a class="nav-link text-white" href="faculty_grades.php"><i class="fas fa-align-justify"></i> Grades</a></h6>
                        </li>
                        <li class="nav-item">
