            ...
            <table class="table text-center">
                ...
                <tbody>
                    <?php
                        ...
                        $sql = mysqli_query($con, "select lrn, username, password from users where lrn = '$id'");
                    ...
                    <tr>
                        ...
                        <td>
                            <button type="button" class="btn btn-info" data-toggle="modal" data-target="#update<?php echo $row['lrn'] ?>">
                                Update
                            </button>
