...
<div class="modal fade" id="update<?php echo $row['section_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header bg-info">
                <h5 class="modal-title text-light" id="exampleModalCenterTitle">Update Grade Level</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form method="post" action="../admin/includes/update_grade_level_info.php" class="mt-3">
                        <h5 class="text-primary" style="text-align: center;">Grade Level Information</h5>
                    <hr>
                    
                    <div class="form-group">
                        <label for="lrn">Section Name</label>
                        <input type="text" class="form-control" name="name" id="lrn" aria-describedby="emailHelp" value="<?php echo $row['section_name']; ?>" required>
                    </div>
