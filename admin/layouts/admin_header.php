        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-2 bg-secondary mt-5" style="height: 650px; position: fixed;">
                    ...
                    <li class="nav-item">
                            <h6><a class="nav-link" href="manage_faculty.php"><i class="fas fa-chalkboard-teacher"></i> Faculty</a></h6>
                        </li>
                        <li class="nav-item">
                            <h6><a class="nav-link" href="manage_subject.php"><i class="fas fa-book"></i> Subject</a></h6>
                        </li>
                        <li class="nav-item">
                            <h6><a class="nav-link" href="schedule.php"><i class="far fa-calendar-check"></i> Schedule</a></h6>
                        </li>
                        <!--
                        <li class="nav-item">
                            <h6><a class="nav-link" href="grade_level.php"><i class="fas fa-clipboard-list"></i> Section</a></h6>
                        </li>
                        -->
                        <li class="nav-item">
                            <h6><a class="nav-link" href="faculty_account.php"><i class="far fa-user-circle"></i> Faculty Acc</a></h6>
                        </li>
                        <li class="nav-item">
